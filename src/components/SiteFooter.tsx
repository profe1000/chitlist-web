  ...
  return (
    <footer id={isHome ? 'contact' : undefined} className="bg-[#2a160c] text-[#f8ead5]">
      <div className={`page-shell grid gap-10 ${isHome ? 'py-14 lg:grid-cols-[1.3fr_.8fr_.8fr_1fr]' : 'py-12 lg:grid-cols-[1.2fr_.8fr_.9fr_1.2fr]'} sm:grid-cols-2`}>
        ...
        <div className="footer-links"><h3>Quick Links</h3><Link to="/#home">Home</Link><Link to="/#story">About Us</Link><Link to="/#services">Our Services</Link>{isHome ? <Link to="/#locations">Our Locations</Link> : <Link to="/contact">Contact Us</Link>}</div>
